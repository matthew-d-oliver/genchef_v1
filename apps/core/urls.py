...
from . import views
from .views import FetchAIContentView, CreateRecipeView, menu, recipe_detail, recipe_options
...
urlpatterns = [
    ...
    path('api/create-recipe/', CreateRecipeView.as_view(), name='create_recipe'),
]
